...
# Digital Hangar v3.5: Turbofan Prognostics & MLOps Suite

An engineering focused predictive maintenance dashboard built to monitor, benchmark, and evaluate Machine Learning pipelines against simulated run-to-failure jet engine telemetry.
...
## System Architecture & Pipeline Lanes
The suite ingests raw data and processes it through three distinct inference lanes:
1. **Thermodynamic Lane (Deployed):** Calculates isentropic compressor efficiency ($\eta$) via the Brayton Cycle and maps thermal breakdown via Exhaust Gas Temperature (EGT) Margins.
...
## Model Matrix & Benchmarking Results
